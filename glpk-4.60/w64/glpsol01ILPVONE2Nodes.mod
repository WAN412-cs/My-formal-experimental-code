...
s.t. SlotOfLinkConstraint101{(m,n) in Ev,k in MBSet,(i,j) in E,s in Vf,t in Vf}: (f[i,j,m,n,s,t,k+1]-f[i,j,m,n,s,t,k]+1)*B[m,n]>=sum{p in PMSet[i,j,m,n,k]}f[i,j,m,n,s,t,p];
/*-----------------end------------------------------------------------------*/
...
set PMSet[1,0,0,1,5]:=;
/*
set PMSet[1,0,0,2,0]:=2 3 4 5;
set PMSet[1,0,0,2,1]:=3 4 5;
set PMSet[1,0,0,2,2]:=3 4 5;
set PMSet[1,0,0,2,3]:=5;
set PMSet[1,0,0,2,4]:=;
set PMSet[1,0,0,2,5]:=;
*/
set PMSet[0,1,0,1,0]:=2 3 4 5;
set PMSet[0,1,0,1,1]:=3 4 5;
set PMSet[0,1,0,1,2]:=4 5;
set PMSet[0,1,0,1,3]:=5;
set PMSet[0,1,0,1,4]:=;
set PMSet[0,1,0,1,5]:=;
/*
set PMSet[0,1,0,2,0]:=2 3 4 5;
...
set PMSet[0,1,0,2,5]:=;
*/
set PMSet[1,2,0,1,0]:=2 3 4 5;
set PMSet[1,2,0,1,1]:=3 4 5;
set PMSet[1,2,0,1,2]:=4 5;
set PMSet[1,2,0,1,3]:=5;
set PMSet[1,2,0,1,4]:=;
set PMSet[1,2,0,1,5]:=;
/*
set PMSet[1,2,0,2,0]:=2 3 4 5;
...
set PMSet[1,2,0,2,5]:=;
*/
set PMSet[2,1,0,1,0]:=2 3 4 5;
set PMSet[2,1,0,1,1]:=3 4 5;
...
set PMSet[2,1,0,2,5]:=;
*/
set PMSet[2,0,0,1,0]:=2 3 4 5;
set PMSet[2,0,0,1,1]:=3 4 5;
set PMSet[2,0,0,1,2]:=4 5;
set PMSet[2,0,0,1,3]:=5;
set PMSet[2,0,0,1,4]:=;
set PMSet[2,0,0,1,5]:=;
/*
set PMSet[2,0,0,2,0]:=2 3 4 5;
...
set PMSet[2,0,0,2,5]:=;
*/
set PMSet[0,2,0,1,0]:=2 3 4 5;
set PMSet[0,2,0,1,1]:=3 4 5;
set PMSet[0,2,0,1,2]:=4 5;
set PMSet[0,2,0,1,3]:=5;
set PMSet[0,2,0,1,4]:=;
set PMSet[0,2,0,1,5]:=;
/*
set PMSet[0,2,0,2,0]:=2 3 4 5;
...
set PMSet[2,3,0,1,0]:=2 3 4 5;
set PMSet[2,3,0,1,1]:=3 4 5;
set PMSet[2,3,0,1,2]:=4 5;
set PMSet[2,3,0,1,3]:=5;
set PMSet[2,3,0,1,4]:=;
set PMSet[2,3,0,1,5]:=;
/*
set PMSet[2,3,0,2,0]:=2 3 4 5;
...
set PMSet[2,3,0,2,5]:=;
*/
set PMSet[3,2,0,1,0]:=2 3 4 5;
set PMSet[3,2,0,1,1]:=3 4 5;
set PMSet[3,2,0,1,2]:=4 5;
set PMSet[3,2,0,1,3]:=5;
set PMSet[3,2,0,1,4]:=;
set PMSet[3,2,0,1,5]:=;
/*
set PMSet[3,2,0,2,0]:=2 3 4 5;
...
set PMSet[3,2,0,2,5]:=;
*/
set PMSet[4,0,0,1,0]:=2 3 4 5;
set PMSet[4,0,0,1,1]:=3 4 5;
set PMSet[4,0,0,1,2]:=4 5;
set PMSet[4,0,0,1,3]:=5;
set PMSet[4,0,0,1,4]:=;
set PMSet[4,0,0,1,5]:=;
/*
set PMSet[4,0,0,2,0]:=2 3 4 5;
...
set PMSet[4,0,0,2,5]:=;
*/
set PMSet[0,4,0,1,0]:=2 3 4 5;
set PMSet[0,4,0,1,1]:=3 4 5;
set PMSet[0,4,0,1,2]:=4 5;
set PMSet[0,4,0,1,3]:=5;
set PMSet[0,4,0,1,4]:=;
set PMSet[0,4,0,1,5]:=;
/*
set PMSet[0,4,0,2,0]:=2 3 4 5;
...
set PMSet[4,3,0,1,0]:=2 3 4 5;
set PMSet[4,3,0,1,1]:=3 4 5;
set PMSet[4,3,0,1,2]:=4 5;
set PMSet[4,3,0,1,3]:=5;
set PMSet[4,3,0,1,4]:=;
set PMSet[4,3,0,1,5]:=;
/*
set PMSet[4,3,0,2,0]:=2 3 4 5;
...
set PMSet[4,3,0,2,5]:=;
*/
set PMSet[3,4,0,1,0]:=2 3 4 5;
set PMSet[3,4,0,1,1]:=3 4 5;
set PMSet[3,4,0,1,2]:=4 5;
set PMSet[3,4,0,1,3]:=5;
set PMSet[3,4,0,1,4]:=;
set PMSet[3,4,0,1,5]:=;
/*
set PMSet[3,4,0,2,0]:=2 3 4 5;
...
set PMSet[5,3,0,1,0]:=2 3 4 5;
set PMSet[5,3,0,1,1]:=3 4 5;
set PMSet[5,3,0,1,2]:=4 5;
set PMSet[5,3,0,1,3]:=5;
set PMSet[5,3,0,1,4]:=;
set PMSet[5,3,0,1,5]:=;
/*
set PMSet[5,3,0,2,0]:=2 3 4 5;
...
set PMSet[5,3,0,2,5]:=;
*/
set PMSet[3,5,0,1,0]:=2 3 4 5;
set PMSet[3,5,0,1,1]:=3 4 5;
set PMSet[3,5,0,1,2]:=4 5;
set PMSet[3,5,0,1,3]:=5;
set PMSet[3,5,0,1,4]:=;
set PMSet[3,5,0,1,5]:=;
/*
set PMSet[3,5,0,2,0]:=2 3 4 5;
...
set PMSet[3,5,0,2,5]:=;
*/
set PMSet[5,4,0,1,0]:=2 3 4 5;
set PMSet[5,4,0,1,1]:=3 4 5;
set PMSet[5,4,0,1,2]:=4 5;
set PMSet[5,4,0,1,3]:=5;
set PMSet[5,4,0,1,4]:=;
set PMSet[5,4,0,1,5]:=;
/*
set PMSet[5,4,0,2,0]:=2 3 4 5;
...
set PMSet[5,4,0,2,5]:=;
*/
set PMSet[4,5,0,1,0]:=2 3 4 5;
set PMSet[4,5,0,1,1]:=3 4 5;
set PMSet[4,5,0,1,2]:=4 5;
set PMSet[4,5,0,1,3]:=5;
set PMSet[4,5,0,1,4]:=;
set PMSet[4,5,0,1,5]:=;
/*
set PMSet[4,5,0,2,0]:=2 3 4 5;
...
set PMSet[6,0,0,1,0]:=2 3 4 5;
set PMSet[6,0,0,1,1]:=3 4 5;
set PMSet[6,0,0,1,2]:=4 5;
set PMSet[6,0,0,1,3]:=5;
set PMSet[6,0,0,1,4]:=;
set PMSet[6,0,0,1,5]:=;
/*
set PMSet[6,0,0,2,0]:=2 3 4 5;
...
set PMSet[6,0,0,2,5]:=;
*/
set PMSet[0,6,0,1,0]:=2 3 4 5;
set PMSet[0,6,0,1,1]:=3 4 5;
set PMSet[0,6,0,1,2]:=4 5;
set PMSet[0,6,0,1,3]:=5;
set PMSet[0,6,0,1,4]:=;
set PMSet[0,6,0,1,5]:=;
/*
set PMSet[0,6,0,2,0]:=2 3 4 5;
...
set PMSet[2,7,0,1,0]:=2 3 4 5;
set PMSet[2,7,0,1,1]:=3 4 5;
set PMSet[2,7,0,1,2]:=4 5;
set PMSet[2,7,0,1,3]:=5;
set PMSet[2,7,0,1,4]:=;
set PMSet[2,7,0,1,5]:=;
/*
set PMSet[2,7,0,2,0]:=2 3 4 5;
...
set PMSet[2,7,0,2,5]:=;
*/
set PMSet[7,2,0,1,0]:=2 3 4 5;
set PMSet[7,2,0,1,1]:=3 4 5;
set PMSet[7,2,0,1,2]:=4 5;
set PMSet[7,2,0,1,3]:=5;
set PMSet[7,2,0,1,4]:=;
set PMSet[7,2,0,1,5]:=;
/*
set PMSet[7,2,0,2,0]:=2 3 4 5;
...
set PMSet[7,2,0,2,5]:=;
*/
set PMSet[5,8,0,1,0]:=2 3 4 5;
set PMSet[5,8,0,1,1]:=3 4 5;
set PMSet[5,8,0,1,2]:=4 5;
set PMSet[5,8,0,1,3]:=5;
set PMSet[5,8,0,1,4]:=;
set PMSet[5,8,0,1,5]:=;
/*
set PMSet[5,8,0,2,0]:=2 3 4 5;
...
set PMSet[5,8,0,2,5]:=;
*/
set PMSet[8,5,0,1,0]:=2 3 4 5;
set PMSet[8,5,0,1,1]:=3 4 5;
set PMSet[8,5,0,1,2]:=4 5;
set PMSet[8,5,0,1,3]:=5;
set PMSet[8,5,0,1,4]:=;
set PMSet[8,5,0,1,5]:=;
/*
set PMSet[8,5,0,2,0]:=2 3 4 5;
...
set PMSet[8,5,0,2,5]:=;
*/
set PMSet[9,3,0,1,0]:=2 3 4 5;
set PMSet[9,3,0,1,1]:=3 4 5;
set PMSet[9,3,0,1,2]:=4 5;
set PMSet[9,3,0,1,3]:=5;
set PMSet[9,3,0,1,4]:=;
set PMSet[9,3,0,1,5]:=;
/*
set PMSet[9,3,0,2,0]:=2 3 4 5;
...
set PMSet[9,3,0,2,5]:=;
*/
set PMSet[3,9,0,1,0]:=2 3 4 5;
set PMSet[3,9,0,1,1]:=3 4 5;
set PMSet[3,9,0,1,2]:=4 5;
set PMSet[3,9,0,1,3]:=5;
set PMSet[3,9,0,1,4]:=;
set PMSet[3,9,0,1,5]:=;
/*
set PMSet[3,9,0,2,0]:=2 3 4 5;
