...
s.t. SlotOfLinkConstraint101{(m,n) in Ev,k in MBSet,(i,j) in E,s in Vf,t in Vf}: (f[i,j,m,n,s,t,k+1]-f[i,j,m,n,s,t,k]+1)*B[m,n]>=sum{p in PMSet[i,j,m,n,k+1]}f[i,j,m,n,s,t,p];
/*-----------------end------------------------------------------------------*/
